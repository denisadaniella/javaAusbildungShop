create table address (id integer generated by default as identity, city varchar(255), country varchar(255), county varchar(255), street varchar(255), primary key (id));
create table customer (id integer generated by default as identity, firstname varchar(255), lastname varchar(255), username varchar(255), primary key (id));
create table location (id integer generated by default as identity, name varchar(255), addressid integer, primary key (id));
create table orderdetail (id integer generated by default as identity, quantity integer, orderid integer not null, productid integer not null, primary key (id));
create table orders (id integer generated by default as identity, addressid integer, customerid integer, locationid integer, primary key (id));
create table product (id integer generated by default as identity, description varchar(255), name varchar(255), price decimal(19,2), weight double, productcategoryid integer not null, supplierid integer not null, primary key (id));
create table productcategory (id integer generated by default as identity, description varchar(255), name varchar(255), primary key (id));
create table stock (id integer generated by default as identity, quantity integer, locationid integer not null, productid integer not null, primary key (id));
