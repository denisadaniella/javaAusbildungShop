...
create table if not exists  customer (id integer generated by default as identity, firstname varchar(255), lastname varchar(255), username varchar(255) not null, primary key (id));
...
create table if not exists  orders (id integer generated by default as identity, addressid integer not null, customerid integer not null, locationid integer not null, primary key (id));
